...
document.getElementById('upload').onclick = function () {
  ...
  axios.post('/up', data, config).then(function (res) {//output.className = 'container';
...
document.getElementById('download').onclick = function () {
  ...
  axios.get('/down').then(function (res) {//output.className = 'container';
    //output.innerHTML = res.data;
  })["catch"](function (err) {
    output.className = 'text-2xl text-red-500 mt-10';
    output.innerHTML = err.message;
...
__webpack_require__(/*! /home/projects/speedtest/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /home/projects/speedtest/src/app.scss */"./src/app.scss");
